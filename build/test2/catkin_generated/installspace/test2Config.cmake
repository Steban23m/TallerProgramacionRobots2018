...
if("FALSE" STREQUAL "TRUE")
  set(test2_SOURCE_PREFIX /home/esteban/tum_simulator_ws/src/test2)
  set(test2_DEVEL_PREFIX /home/esteban/tum_simulator_ws/devel)
  set(test2_INSTALL_PREFIX "")
  set(test2_PREFIX ${test2_DEVEL_PREFIX})
else()
  set(test2_SOURCE_PREFIX "")
  set(test2_DEVEL_PREFIX "")
  set(test2_INSTALL_PREFIX /home/esteban/tum_simulator_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'esteban <esteban@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/esteban/tum_simulator_ws/install/${idir}'.  Ask the maintainer 'esteban <esteban@todo.todo>' to fix it.")
    endif()
